...
public class BonusEnergia extends Actor {

	private int velX, velY;
	private Texture texture;
	private TextureRegion bonusEnergia;
	...
	public BonusEnergia() {
		...
		tiempo = 0f;
		bonusEnergia = temporalRegions[0][0];
		setSize(bonusEnergia.getRegionWidth(), bonusEnergia.getRegionHeight());
	...
	public void draw(Batch batch, float parentAlpha) {
		batch.draw(bonusEnergia, getX(), getY(), bonusEnergia.getRegionWidth(), bonusEnergia.getRegionHeight());
	...
	public void act(float delta) {
		...
		bonusEnergia = (TextureRegion) animacion.getKeyFrame(tiempo, true);
